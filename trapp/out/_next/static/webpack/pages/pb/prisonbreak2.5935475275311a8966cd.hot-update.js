...
const Chat = ({
  ...
  const handleKeyDown = event => {
    ...
    if (event.key === "Backspace" && nextmsg.length > 0) {
      let newNextmsg = nextmsg.splice(nextmsg.length - 1, 1);
      setNextmsg(newNextmsg);
    }
  };
