...
const Game = ({
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    ...
    window.alert("Welcome to prison break! " + racksize + initialtiles.length + squares.length + usedby.length);
