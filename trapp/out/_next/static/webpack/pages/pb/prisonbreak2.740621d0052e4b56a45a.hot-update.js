...
const Game = ({
  ...
  const endPrisonersTurn = () => {
    ...
    let escapehatches = ["0-0", "0-" + middle, "0-" + egde, middle + "-0", middle + "-" + edge, edge + "-0", edge + "-" + middle, edge + "-" + edge]; // coords of escape hatches
