...
const Square = props => {
  ...
  const tdclass = "pbSquareInner" + props.c !== squareunused ? " " + props.squareusedby + (props.c === "Q" ? " u" : "") : props.rcd[0] === props.ri && props.rcd[1] === props.ci && props.rcd[2] === "r" ? " RightArrow" : props.rcd[0] === props.ri && props.rcd[1] === props.ci && props.rcd[2] === "d" ? " DownArrow" : props.ri === middle && props.ci === middle ? " CenterSquare" : (props.ri === 0 || props.ri === middle || props.ri === edge) && (props.ci === 0 || props.ci === middle || props.ci === edge) ? " EscapeHatch" : props.ri % 2 === props.ci % 2 ? " style1" : " style2"; // Alternating square styles
  ...
  const tdvalue = props.c !== squareunused ? props.c : tdclass.indexOf("RightArrow") > -1 ? "➡" : tdclass.indexOf("DownArrow") > -1 ? "⬇" : tdclass.indexOf("CenterSquare") > -1 ? /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxDEV"])("i", {
    ...
    lineNumber: 497,
    columnNumber: 9
  }, undefined) : tdclass.indexOf("EscapeHatch") > -1 ? "ꐕ" : props.ri % 2 === props.ci % 2 ? "." : ".";
  console.log(tdclass);
