...
const Game = ({
  ...
  const sendNextMessage = jMessage => {
    let newSnats = [...snats];
    newSnats.push(`Sending message: func=${jMessage.func} at ${Date.now().toString('h:MM:ss')}`);
