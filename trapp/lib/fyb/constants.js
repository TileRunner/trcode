...
export const S2C_FUNC_GAMELIST = 'GAME_LIST'; // Sending game list
export const S2C_FUNC_CHATDATA = 'CHAT_DATA'; // Sending chat data
// Ping interval
export const PING_INTERVAL = 20000; // Ping server every this many milliseconds
