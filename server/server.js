...
const useDataApi = false; // So I can turn off data api for testing
...
const processMessage = (message) => {
    ...
    interactWithClients(pm, message);
    if (useDataApi) {
        interactWithDataApi(pm);
    }
}

function interactWithClients(pm, message) {
...
function interactWithDataApi(pm) {
    if (pm.clientType === "pb") {
        if (pm.func === "startgame") {
            ...
            postGame(jStartGame); // Send new game to data API
        }
